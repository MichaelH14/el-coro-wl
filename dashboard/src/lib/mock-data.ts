...
export const agents: Agent[] = [
  ...
  { id: "a24", name: "migration-assistant", layer: "Specialists", model: "sonnet", color: "yellow", status: "active", description: "Guía de migración de stack y servidor", role: "Guía migraciones entre versiones o servidores. Siempre con plan de rollback.", triggers: "Cuando necesitas migrar algo — como cuando cambiaste de proveedor de hosting o de plataforma de bot." },
