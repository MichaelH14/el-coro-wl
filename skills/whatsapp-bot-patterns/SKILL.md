...
description: Use when building or modifying a WhatsApp bot, handling messages, media, groups, sessions, or bot commands
---

# WhatsApp Bot Patterns

Build WhatsApp bots via your WhatsApp gateway service. Message handling, state management, media, and rate limiting.

## Preconditions

- WhatsApp gateway active (`ws://127.0.0.1:18789`)
...
1. Receive from the WhatsApp gateway (WebSocket)
